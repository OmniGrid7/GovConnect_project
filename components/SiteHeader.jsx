...
export default function SiteHeader() {
  ...
  return <header>
    ...
    <nav className="main-nav" aria-label={t('directory')}><Link href="/">{t('home')}</Link><Link href="/#directory">{t('directory')}</Link><Link href="/categories/scheme-and-programme-and-mission-and-application">{t('schemes')}</Link><Link href="/departments">{t('departments')}</Link><Link href="/emergency-numbers">{t('emergencyNumbers')}</Link><Link href="/categories/district-portal">{t('districts')}</Link></nav>
